...
params.trial.reward_duration = 2000;
params.trial.transition_duration = 1500;
...
params.task.prac.number_of_trials = 40;  %nathaniel & Peter S had 50 (outside scanner); 2 for debug.
                                         % 30 in nspn / uchange v. 20121209
params.task.test.number_of_trials = 121; % %nathaniel & Peter S had 201 (in  scanner); 5 for debug.
                                         % 69 in nspn / uchange v. 20121209
...
params.task.iti = [1 2];   % was [1 3] in nspn / uchange v. 20121209
...
params.task.break.duration = 5; % Was 30 in nspn / uchange v. 20121209
