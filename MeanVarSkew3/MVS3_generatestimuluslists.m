function listout = MVS3_generatestimuluslists(numblocks, trials_per_block, sure_amounts, entryix)
% This function loads a stimulus list, pre-generated with SKEWLIST_maker. It
% is used in MVS3_get_list as per LIST = MVS3_generatestimuluslists(...
...
elseif entryix == 5   % Used for NSPN behavioural (emulscanning)
    entrystr = 'NSPNscanning1';
elseif entryix == 6   % Used for NSPN fMRI scanning
    entrystr = 'NSPNscanning1';
elseif entryix == 10
...
switch entrystr
    ...
    case 'NSPNscanning0' %'old-fashioned' type stimuli for orinal fMRI code
